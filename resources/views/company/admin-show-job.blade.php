    ...
    <div class="flex justify-center mb-20">
        ...
        <div class="w-5/6">
            ...
            <div class="flex justify-between mb-20">
                ...
                <a href="{{ url('/all-listed-jobs') }}" class="mt-5 ml-5 inline-block border-2 font-bold 
        ...
        shadow-lg">
                ...
                <a href="{{ url('/all-listed-jobs/'.$job -> job_code.'/edit') }}" class="transition duration-200 mt-5 ml-5 
