<x-layout>
    ...
    <div class="flex justify-center mb-20">
        <div class="w-5/6">
            ...
            <a href="/home" class="mt-5 mb-10 ml-5 inline-block border-2 font-bold 
        ...
        shadow-lg">
            ...
            <div class="flex justify-center mt-10">
                ...
                <a href="/partner-view-cv/{{$cv -> cv_code}}/edit" class="bg-blue-600 text-white px-4 py-2 rounded-lg 
